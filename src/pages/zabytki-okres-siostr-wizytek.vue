<template id="">
  ...
  <section>
    ...
    <p>Kościół wówczas został kościołem filialnym, obsługiwanym przez duchowieństwo diecezjalne i administrowany przez powoływanych kolejno rektorów, po czasy współczesne.</p>
  </section>
  <section>
